...
async function getPriorityFeeEstimate(transaction, priorityLevel = constants_1.PRIORITY_LEVEL) {
    ...
    (0, output_1.verboseLog)(`Estimating priority fee via Helius...`);
    try {
        ...
        (0, output_1.verboseLog)(`Priority fee estimate: ${adjustedSol} SOL`);
        return adjustedSol <= 0 ? constants_1.DEFAULT_PRIORITY_FEE_SOL : adjustedSol;
    }
    catch (e) {
        (0, output_1.verboseLog)(`Priority fee estimation failed, using default`);
