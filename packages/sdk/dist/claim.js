 ...
 */
async function buildClaimTransaction(id = 'claim', amount = 0, side = 'H', priorityFee = constants_1.DEFAULT_PRIORITY_FEE_SOL) {
    ...
    (0, logger_1.verboseLog)(`Building reveal tx...`);
    try {
...
async function claimReward(id = 'claim', amount = 0, side = 'H', priorityFee = constants_1.DEFAULT_PRIORITY_FEE_SOL) {
    try {
        ...
        if (walletAdapter) {
            ...
            const conn = (0, anchor_1.getConnection)();
            ...
            (0, logger_1.verboseLog)(`Claim tx: ${signature}`);
            return signature;
        }
        else {
